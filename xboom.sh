...
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .outpucurl -s "https://xlr8-api.herokuapp.com/bomb/$targett"
...
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett"
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett"
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett"t.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
curl -s "https://xlr8-api.herokuapp.com/bomb/$targett" > .output.txt
